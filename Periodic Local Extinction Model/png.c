...
/* This function is my own addition. Note that the use of this function
   makes mpeg.par wrong. */
void ResetNFrames(const int new_nframes)
{
  nframes = new_nframes;
}
...
int PlanePNG(TYPE **a, int c)
{
  ...
  /* my modification: The next line had been
